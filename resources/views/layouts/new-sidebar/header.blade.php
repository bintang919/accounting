        ...
        <div class="button_language dropdown p-2 ms-2">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('language.switch', 'en') }}">
                    <img class="flag-icon" src="{{ asset('assets/flags/gb.svg') }}"> {{ __('translate.English') }}
                </a></li>
            
                <li><a class="dropdown-item" href="{{ route('language.switch', 'fr') }}">
                    <img class="flag-icon" src="{{ asset('assets/flags/fr.svg') }}"> {{ __('translate.French') }}
                </a></li>
            
                <li><a class="dropdown-item" href="{{ route('language.switch', 'ar') }}">
                    <img class="flag-icon" src="{{ asset('assets/flags/sa.svg') }}"> {{ __('translate.Arabic') }}
                </a></li>
            
                <li><a class="dropdown-item" href="{{ route('language.switch', 'id') }}">
                    <img class="flag-icon" src="{{ asset('assets/flags/id.svg') }}"> {{ __('translate.Indonesian') }}
                </a></li>
            </ul>
